...
describe('instance', () => {
  ...
  test('should make a http request withour verb helper', () => {
  ...
  test('should have defaults.heders', () => {
  ...
  test('should get the computed uri', () => {
    ...
    expect(axios.getUri(fakeConfig)).toBe(
      'https://www.baidu.com/user/12345?idClient=1&idTest=2&testString=testString'
    )
  })
})
