...
describe('CancelToken', () => {
  describe('reason', () => {
    test('should returns a Cancel if cancellation have been requested', () => {
      let cancel: Canceler
  ...
  describe('promise', () => {
    test('should returns a Promise that resolves when cancellation have been requested', done => {
      let cancel: Canceler
      let token = new CancelToken(c => {
        cancel = c
      })
